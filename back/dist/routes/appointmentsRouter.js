...
const appointmentsController_2 = require("../controllers/appointmentsController");
...
appointmentsRouter.post("/schedule", (req, res) => (0, appointmentsController_2.registerAppointmentsController)(req, res));
appointmentsRouter.put("/cancel/:id", (req, res) => (0, appointmentsController_1.cancelStatusAppointmentsController)(req, res));
